---
path: "/docs/reference/collect/run"
date: "2019-10-09"
linktitle: "Run"
weight: 1009
title: "Run"
...
In addition to the [shared collector properties](/docs/reference/collect/reference#shared-properties), the `run` collector accepts the following parameters:
