...
<div className="side-by-side">
  <div className="flex1 flex-column justifyContent--spaceBetween">
    <div className="flex-auto">
      <h4>Create your own</h4>
      <p>Learn how to add custom preflight checks and support bundles to your application.</p>
    </div>
    <div>
      <a href="/docs/preflight/introduction" className="custom-button primary">
        Start the tutorial!
      </a>
    </div>
  </div>
  ...
  <div className="flex1 flex-column justifyContent--spaceBetween">
    ...
    <div>
      <a href="/docs/collect" className="custom-button primary">
        Read docs!
      </a>
    </div>
  </div>
