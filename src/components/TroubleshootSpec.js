...
class TroubleshootSpec extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="u-minHeight--full u-width--full u-overflow--auto flex-column flex1 u-marginBottom---40 container">
        <div className="section landing-header flex-1-auto flex u-width--full justifyContent--center">
          ...
          <div className="flex flex1 flex-column u-marginLeft--50">
            ...
            <div className="u-borderTop--gray u-marginBottom--30">
              ...
              <div className="u-marginTop--30 u-flexMobileReflow two-btn-wrapper">
                ...
                <button className={`Button primary darkBlue tab ${isActive === "supportbundle" && "is-active-blue"}`} onClick={() => this.onTryItOut("supportbundle")}><span className="icon support-small"></span>Support Bundle</button>
              </div>
              {showCodeSnippet &&
