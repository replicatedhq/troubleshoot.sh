---
path: "/docs/reference/collect/logs"
date: "2019-10-09"
linktitle: "Logs"
weight: 1008
title: "Logs"
...
In addition to the [shared collector properties](/docs/reference/collect/reference#shared-properties), the `logs` collector accepts the following parameters:
