---
path: "/docs/reference/collect/exec"
date: "2019-10-09"
linktitle: "Exec"
weight: 1006
title: "Exec"
...
In addition to the [shared collector properties](/docs/reference/collect/reference#shared-properties), the `exec` collector accepts the following parameters:
