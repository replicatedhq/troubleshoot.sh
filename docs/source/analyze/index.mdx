...
*Note: `troubleshoot.sh/v1beta2` was introduced in preflight and support-bundle krew plugin version 0.9.39 and Kots version 1.19.0. Kots vendors should [read the guide to maintain backwards compatibility](/v1beta2/). Also note: Previously, Analyzers could be specified in a standalone file, with `Kind: Analyzer`, however this syntax is depcrecated in Kots 1.19.0 and not supported at all in the krew plugins.*
