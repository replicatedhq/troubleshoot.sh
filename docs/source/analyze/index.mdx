...
Optionally, an analyzer can be set to strict. Setting an analyzer to `strict` is useful as an additional datapoint for analyzers where `outcomes` should not be ignored.
