...
The documentation for `clusterVersion` is in the [Analyze documentation](/docs/analyze/cluster-version/).
...
<img src="../images/first-preflight.png" style={{maxWidth: '700px'}} />
...
This analyzer uses the built in [distribution](/docs/analyze/distribution/) check that has the capabilities of detecting where the cluster is located.
