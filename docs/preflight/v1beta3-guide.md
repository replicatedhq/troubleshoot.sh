---
title: "v1beta3 Authoring Reference"
description: "Detailed reference guide for authoring v1beta3 Preflight specs"
tags: ["preflight", "v1beta3", "reference"]
sidebar_position: 6
---

:::info Looking for an introduction to v1beta3?
- **New to v1beta3?** Start with the [v1beta3 Overview](./v1beta3-overview.md) for features, examples, and usage
- **Migrating from v1beta2?** See the [Migration Guide](./v1beta3-migration.md) for step-by-step conversion
- **Want a detailed reference?** Continue reading this guide
:::
