        ...
        <div className="section landing-header border">
          <div className="container">
            <div className="contain-700">
              ...
              <p className="u-fontSize--24 u-marginTop--30 u-color--biscay u-lineHeight--more u-fontWeight--medium">Decoupled support and validation for Kubernetes applications</p>
