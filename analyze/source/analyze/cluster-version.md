...
The clusterVersion analyzer requires that that [clusterInfo](https://troubleshoot.io) is included in the support bundle. The clusterInfo collector is automatically added and will always be present.
